...
class GyudonDeliveryPage extends StatelessWidget {
  final List<String> favoriteItems = []; // รายการ Favorite

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("ข้าวหน้าเนื้อ"),
          ...
          child: Column(
            children: [
              buildDeliveryCard(
                ...
                "assets/rice/shop/r2/1.png",
                "เนื้อชิ้นหนานุ่ม ราดซอสกลมกล่อม เสิร์ฟพร้อมไข่แดงเยิ้มๆ ในบรรยากาศอิซากายะแบบญี่ปุ่นแท้ๆ",
                "ราคา: 250 บาท",
              ),
              SizedBox(height: 20),
              buildDeliveryCard(
                context,
                "Wagyu Niku Yaki Don",
                "assets/rice/shop/r2/2.png",
                "ข้าวหน้าเนื้อวากิวระดับพรีเมียม ท็อปด้วยไข่แดงสด นุ่มละลายในปาก พร้อมวิวเมืองสุดหรู",
                "ราคา: 450 บาท",
              ),
              SizedBox(height: 20),
              buildDeliveryCard(
                context,
                "ข้าวหน้าเนื้อฟัวกราส์",
                "assets/rice/shop/r2/3.png",
                "ข้าวหน้าเนื้อวากิวระดับพรีเมียม ท็อปด้วยไข่แดงสด นุ่มละลายในปาก พร้อมวิวเมืองสุดหรู",
                "ราคา: 390 บาท",
              ),
            ],
