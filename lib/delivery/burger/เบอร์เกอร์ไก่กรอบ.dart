...
class ChickenBurgerDeliveryPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("เบอร์เกอร์ไก่กรอบ"),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              buildDeliveryCard(
                context,
                "เบอร์เกอร์ไก่ทอด by KRUA.CO",
                "assets/burger/b2/4.png",
                "เบอร์เกอร์ไก่ทอดใช้เนื้อสะโพกหมักกับนมและเครื่องเทศ คลุกแป้งทอดแล้วนำไปทอดจนกรอบ เสิร์ฟในขนมปังงาพร้อมผักคอส หอมแดง พริกเจลาปิโน โคลสลอว์ และซอสสไปซี่มาโย.",
                "ราคา: 120 บาท",
              ),
              SizedBox(height: 20),
              buildDeliveryCard(
                context,
                "Ramen Chicken Burgers (เบอร์เกอร์ไก่ราเมนกรอบ)",
                "assets/burger/b2/5.jpg",
                "สะโพกไก่ชิ้นใหญ่ทอด กรุบกรอบด้วยเกล็ดบะหมี่กึ่งสำเร็จรูป เสิร์ฟมาในรูปแบบเบอร์เกอร์ พร้อมกับกิมจิสลอว์ มายองเนสโคชูจัง และชีสเชดด้า",
                "ราคา: 150 บาท",
              ),
              SizedBox(height: 20),
              buildDeliveryCard(
                context,
                "McDonald's ใหม่! เบอร์เกอร์ไก่กรอบซอสสะเด็ด",
                "assets/burger/b2/6.webp",
                "เริ่มต้นเพียงชิ้นละ 99 บาท ร่วมโปรทั้งซื้อที่ร้าน ไดร์ฟทรู และบริการจัดส่งถึงบ้าน ตั้งแต่วันที่ 16 กันยายน 2563 - 27 ตุลาคม 2563 (หรือจนกว่าสินค้าจะหมด)",
                "ราคา: 99 บาท",
              ),
            ],
          ),
